                  ...
                  ? Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: FileImage(File(profileProvider.proImage!.path)),
                          fit: BoxFit.cover,
                        ),
                      ),
                    )
                  ...
                  return InkWell(
                    onTap: () {
                      switch (index) {
                        case 0:
                          Navigator.pushNamed(
                              context, MyProfileScreen.myProfileScreenRoutes);
                          break;
                        case 1:
                        ...
                        case 3:
                          Navigator.pushNamed(
                              context, SettingScreen.settingScreenRoute);
                          break;
                        case 4:
                          ...
                          Container(
                            ...
                            child: Center(
                              child: SvgPicture.asset(
                                  "${profileProvider.profileData[index]["icon"]}"),
                            ),
                          ),
                          const SizedBox(width: 16),
                          Text(
                            "${profileProvider.profileData[index]["title"]}",
                            style: TextStyles.subTitle,
                          ),
                          const Spacer(),
